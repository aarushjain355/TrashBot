...
: ${AMENT_CURRENT_PREFIX:="/home/vicky/TrashBot_ws/src/install/robot_body_planning"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_body_planning/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_body_planning/environment/path.sh"
